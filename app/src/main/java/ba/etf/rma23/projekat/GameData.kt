...
class GameData {
    companion object Data {
        ...
        var staticGames = arrayListOf<Game>(Game(1,"Elden Ring","PC","25.02.2022",9.0,"eldenring","M",
            ...
            ),Game(2,"Counter-Strike: Global Offensive","PC","21.08.2012",9.0,"csgo","M","Valve","Valve",
                ...
                ,Game(3,"Borderlands 3","PC","13.09.2019",9.0,"borderlands3","M","Gearbox Software","2K Games",
                ...
                Game(4,"Don't Starve Together","PC","21.04.2016",10.0,"don_tstarvetogether","T",
                ...
                ,Game(5,"Terraria","PC","16.05.2011",10.0,"terraria","T","Re-Logic","Re-Logic",
                    "Sandbox","Dig, fight, explore, build! Nothing is impossible in this action-packed adventure game.",arrayListOf<UserImpression>()),
                Game(6,"Left 4 Dead 2","PC","17.11.2009",10.0,"left4dead2","M","Valve","Valve","Zombies",
                ...
                Game(7,"Apex Legends","PC","04.02.2019",9.0,"apexlegends","T",
                ...
                Game(8,"League of Legends","PC","27.10.2009",7.6,"leagueoflegends",
                    ...
                    arrayListOf<UserImpression>()),
                Game(9,"VALORANT","PC","02.06.2020",9.0,"valorant","T","Riot Games","Riot Games",
        ...
        /**
         * Za spiralu 3 ovo provjerava da li je igra sacuvana u favoriteGames
         */
        fun getDetails(title: String): Game? {
            var returnGame : Game? = getAll().find { it.title == title }
            if(returnGame == null) returnGame = favoriteGames.find { it.title == title }
            return returnGame
        }
    }
}