...
class DBTest {
    ...
    companion object {
        ...
        suspend fun obrisi() {
            ...
            var builder: Request.Builder = Request.Builder()
                .url(URL("https://rma23ws.onrender.com/account/" + AccountApiConfig.AccountGamesRepository.getHash() + "/gamereviews"))
                .delete()
    ...
    fun a0_countOfflineReviews() = runBlocking {
        AccountApiConfig.AccountGamesRepository.setHash(HASH)
